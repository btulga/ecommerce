...
module.exports = (sequelize, DataTypes) => {
  ...
  Cart.init({
    ...
    shipping_address_id: DataTypes.UUID, // A foreign key referencing the Address model, indicating the shipping address selected for the cart.
    ...
    // price
    subtotal: DataTypes.DECIMAL(12, 5), // нийт үнэ sum (unit_price * quantity)
